            ...
            <div className="container">
                <div className="footer-sections">
                    ...
                    <div className="footer-column">
                        ...
                        <div class=""><h2 class="footer-block__heading" data-toggle-column-footer="">Customer Service</h2><div class="footer-block__details has-content-piece" style="--icon-color: #232323; --icon-size: 20px; --content-spacing: 1px"><div class="rte">
                            ...
                            </span><div><p><a href="mailto:%0Aadmin@961souq.com" title="Admin Contact Email">admin@961souq.com</a></p></div>
                            </div></div>
                        </div>
                        </div>
                        {/* Social Media Links */}
