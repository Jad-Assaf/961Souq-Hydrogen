        ...
        <div ref={scrollRef} className="scrolling-content">
          <a href="/build-your-own-desktop" className="scrolling-item">
            <img
              width={75}
              height={75}
              src="https://cdn.shopify.com/s/files/1/0552/0883/7292/files/56789-600x600.png?v=1742890245&quality=7.5"
              alt=""
            />
            <img
              width={75}
            ...
            <img
              width={75}
              height={75}
              src="https://cdn.shopify.com/s/files/1/0552/0883/7292/files/GM850W__55109.webp?v=1742897748&quality=7.5"
              alt=""
            />
            <img
              width={75}
