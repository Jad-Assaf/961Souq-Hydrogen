                ...
                <Link key={product.id} className="product-item" to={`/products/${product.handle}`}>
                    <div className="product-card">
                        <Image
                            ...
                            srcSet={`${product.images.nodes[0].url}?width=300&quality=50 2000x,
                                     ${product.images.nodes[0].url}?width=600&quality=50 2000x,
                                     ${product.images.nodes[0].url}?width=1200&quality=50 2000x`}
