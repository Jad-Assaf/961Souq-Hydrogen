  ...
  return (
    <div className="product">
      ...
      <div className="ProductPageBottom">
        ...
        <div className="product-section">
          <h2>Warranty</h2>
          <h2>Operational Warranty Terms and Conditions</h2>
          <h3>Warranty Coverage</h3>
          <p>This warranty applies to All Products, purchased from 961 Souq. The warranty covers defects in materials and workmanship under normal use for the period specified at the time of purchase. Warranty periods vary based on the product category.
          </p>
          <h3>What is Covered</h3>
          <p>During the warranty period, 961 Souq will repair or replace, at no charge, any parts that are found to be defective due
            to faulty materials or poor workmanship. This warranty is valid only for the original purchaser and is non-transferable.</p>
          ...
          <ol>
            <li>Contact admin@961souq.com with proof of purchase and a detailed description of the
              issue.</li>
            <li>961 Souq will assess the product and, if deemed defective, repair or replace
              the item at no cost.</li>
          </ol>

          <h3>Limitations and Exclusions</h3>
          <p>This warranty is limited to repair or replacement. 961 Souq will not be liable for any
            indirect, consequential, or incidental damages, including loss of data or loss of profits.</p>
        </div>
